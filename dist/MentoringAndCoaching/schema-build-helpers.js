...
const buildContext = (input = {}) => __awaiter(void 0, void 0, void 0, function* () {
...
const buildSearchRequest = (input = {}) => __awaiter(void 0, void 0, void 0, function* () {
    var _j, _k, _l, _m;
    const context = yield (0, exports.buildContext)({
        action: "search",
        category: "mentoring"
    });
    const intent = {};
    if ((_j = input === null || input === void 0 ? void 0 : input.sessionTitle) === null || _j === void 0 ? void 0 : _j.key) {
        intent.item = {
            descriptor: {
                name: (_k = input === null || input === void 0 ? void 0 : input.sessionTitle) === null || _k === void 0 ? void 0 : _k.key
            }
        };
    }
    if ((_l = input === null || input === void 0 ? void 0 : input.mentor) === null || _l === void 0 ? void 0 : _l.name) {
        intent.agent = {
            person: {
                name: (_m = input === null || input === void 0 ? void 0 : input.mentor) === null || _m === void 0 ? void 0 : _m.name
            }
        };
    }
...
const buildSearchResponse = (response = {}, input = {}) => __awaiter(void 0, void 0, void 0, function* () {
    var _o, _p, _q, _r;
    const context = { transactionId: (_o = response === null || response === void 0 ? void 0 : response.context) === null || _o === void 0 ? void 0 : _o.transaction_id };
    const mentorshipProviders = [];
    const responseMentorShipProviders = (_r = (_q = (_p = response === null || response === void 0 ? void 0 : response.message) === null || _p === void 0 ? void 0 : _p.catalog) === null || _q === void 0 ? void 0 : _q.providers) !== null && _r !== void 0 ? _r : [];
