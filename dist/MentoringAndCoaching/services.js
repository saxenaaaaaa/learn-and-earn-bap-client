...
const searchMentorShipService = (body) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const searchRequest = yield (0, schema_build_helpers_1.buildSearchRequest)(body);
        let searchResponse = {};
        if (jobNetwork !== "local") {
            const headers = { "Content-Type": "application/JSON" };
            let res = yield axios_1.default.post(`${gatewayUrl}/mentor/search`, searchRequest.payload, { headers });
            searchResponse = res === null || res === void 0 ? void 0 : res.data;
        }
        else {
            searchResponse = yield (0, schema_build_helpers_1.buildSearchResponse)(searchMentorShipReponse_json_1.default, body);
        }
